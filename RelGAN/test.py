...
def parse(args=None):
    ...
    parser.add_argument('--dataset', type=str, help='dataset', default='voiceModel', choices=['celeba-hq', 'celeba','voiceModel'])
    parser.add_argument('--config', type=str, help='config file')
    parser.add_argument('--load', type=str, help='load model from file')
    parser.add_argument('--save', type=str, default='model/testweights.pth', help='save model as file')
    parser.add_argument('--steps', type=int, default=100, help='training steps')
    parser.add_argument('--start_step', type=int, default=0, help='start training step')
    parser.add_argument('--name', type=str, help='experiment name')
    parser.add_argument('--gpu', action='store_true')
    parser.add_argument('--multi_gpu', action='store_true')
    parser.add_argument('--repeat_G', type=int, default=10, help='how much repeat G')
...
from data import ImageNpyFolder
test_dataset =ImageNpyFolder(root='C:/Users/ICT/Desktop/youda/AI_TeamRepo/testDatasetv15')
...
if dataset=='voiceModel':
    ...
    valid_dset = wavData(
    'C:/Users/ICT/Desktop/youda/AI_TeamRepo/voiceDatasetv15', selected_attrs=selected_attributes, mode='train', val_num=0
    )
...
# save_image(make_grid(inv_normalize(fixed_img_a), nrow=16), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/valid_img_a.jpg')
# save_image(make_grid(inv_normalize(fixed_img_b), nrow=16), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/valid_img_b.jpg')
...
# save_image(make_grid(inv_normalize(img_a2b), nrow=16), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/valid_img_a2b.jpg')
# save_image(make_grid(inv_normalize(img_a2a), nrow=16), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/valid_img_a2a.jpg')
# save_image(make_grid(inv_normalize(img_a2b2a), nrow=16), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/valid_img_a2b2a.jpg')
...
f00 = make_grid(inv_normalize(f[0,0]), nrow=1)
f01 = make_grid(inv_normalize(f[0,1]), nrow=1)
f10 = make_grid(inv_normalize(f[0,10]), nrow=1)
f = f.view(f.size(0)*f.size(1), f.size(2), f.size(3), f.size(4))
# save_image(make_grid(inv_normalize(f), nrow=len(inter_annos)+1), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/valid_img_inter.jpg')
...
#         img_a2b2a = gan.G(img_a2b, -vec_ab)
#     save_image(inv_normalize(img_a2b), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/t_img_a2b.jpg', nrow=16)
#     save_image(inv_normalize(img_a2a), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/t_img_a2a.jpg', nrow=16)
#     save_image(inv_normalize(img_a2b2a), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGAN/test_result/t_img_a2b2a.jpg', nrow=16)
#     break
...
save_image(make_grid(inv_normalize(f), nrow=len(test_annos)+1), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGANtest_result/test_img.jpg')
save_image(make_grid(inv_normalize(g), nrow=len(inter_annos)+1), 'C:/Users/ICT/Desktop/youda/AI_TeamRepo/AIModel/RelGANtest_result/test_img_inter.jpg')
print('Finished!')